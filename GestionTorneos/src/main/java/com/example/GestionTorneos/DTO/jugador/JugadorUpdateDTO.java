...
public record JugadorUpdateDTO(
        @Size(min = 2, max = 100, message = "El nombre debe " +
                "contener entre 2 y 100 caracteres") String nombre,
        @Min(value = 10, message = "La edad no puede ser menor a 10")
        @Max(value = 90, message = "La edad no puede ser mayor a 90") int edad,
        @Size(min = 3, max = 50, message = "La posicion debe contener entre 2 y 50 caracteres")
        String posicion,
        @Min(value = 1, message = "El dorsal no puede ser menor a 1")
